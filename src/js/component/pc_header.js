	    ...
	    return (
		  <header>
			<Row>
				...
				<Col span={16}>
				   <Menu mode="horizontal" onClick={this.handleClick.bind(this)} selectedKeys={[this.props.currentTitle]}>
						<Menu.Item key="top">
					...
					<Modal title="用户中心" wrapClassName="vertical-center-modal" visible={this.state.modalVisible} onCancel= {()=>this.setModalVisible(false)} onOk={() => this.setModalVisible(false)} okText="关闭">
						<Tabs type="line" onChange={this.callback.bind(this)}>
							<TabPane tab="登录" key="1">
								<Form layout="horizontal" onSubmit={this.handleSubmitLogin.bind(this)}>
									<FormItem label="账户">
							...
							<TabPane tab="注册" key="2">
								<Form layout="horizontal" onSubmit={this.handleSubmitReguster.bind(this)}>
									<FormItem label="账户">
									...
									<FormItem label="确认密码">
									 {getFieldDecorator('r_confirmPassword',{
										...
										})(<Input type="password" placeholder="请再次输入您的密码" onBlur = {this.handleConfirmBlur.bind(this)}/>)}
									</FormItem>
